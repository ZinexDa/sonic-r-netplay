use dashmap::DashMap;
use proto::{HubMessage, PunchToken, ServerId, ServerInfo};
use std::{
    net::SocketAddr,
    sync::Arc,
...
pub struct ServerRecord {
    ...
    pub out_tx: mpsc::UnboundedSender<HubMessage>,
...
pub struct PairSession {
    pub host_tx: mpsc::UnboundedSender<HubMessage>,
    pub client_tx: mpsc::UnboundedSender<HubMessage>,
